...
| Situação | Arquivo |
|---|---|
| Logotipo do site, no Painel | `selo-amarelo-512.png` |
| Fundo escuro | `selo-grafite-512.png` |
...
`selo-amarelo-512.png`. Preencha também o nome como `Alta Pista` e a sigla
...
| | Código | Onde |
|---|---|---|
| Amarelo | `#FFE01B` | fundo do selo, destaques do site |
| Grafite | `#141414` | o monograma, texto |
| Branco | `#FFFFFF` | monograma sobre fundo escuro |

O amarelo é o mesmo da cor de acento do site, então a marca e a interface
combinam sem ajuste.
...
o amarelo por outra cor no selo padrão; para fundos coloridos existe a
