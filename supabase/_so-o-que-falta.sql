-- =============================================================================
--  Balcão de Inscrições — SÓ O QUE PODE ESTAR FALTANDO (0015 + 0016)
--  Cole tudo no SQL Editor do Supabase e clique em Run. Idempotente.
--  Tudo de 0001 a 0014 já está aplicado (os 30 testes de segurança provam).
-- =============================================================================
