...
/* GATILHO REMOVIDO nesta versão: alguns projetos não permitem criar gatilho */
/* em auth.users. O site cria o perfil sozinho no primeiro acesso. */
...
/* envia e apaga. */
/* ============================================================================= */
/* POLÍTICAS DE STORAGE REMOVIDAS nesta versão. */
/* Crie o balde pela tela: Storage › New bucket › nome 'capas' › marque Public. */
/* Depois, em Storage › Policies, permita INSERT e DELETE para 'authenticated'. */
